...
export default function PageIllustration() {
  return (
    <>
      ...
      {/* Circles - CAMBIADOS A NARANJA */}
      <div
        className="pointer-events-none absolute -top-32 left-1/2 ml-[580px] -translate-x-1/2"
        aria-hidden="true"
      >
        <div className="h-80 w-80 rounded-full bg-gradient-to-tr from-[#ff914d] to-orange-300 opacity-40 blur-[160px]" />
      </div>
      <div
        className="pointer-events-none absolute left-1/2 top-[420px] ml-[380px] -translate-x-1/2"
        aria-hidden="true"
      >
        <div className="h-80 w-80 rounded-full bg-gradient-to-tr from-[#ff914d] to-orange-200 opacity-30 blur-[160px]" />
      </div>
      <div
